...
class TestIncludeme(Base):
    ...
    def test_includeme_missing_settings(self):
        ...
        with self.assertRaises(KeyError):
            config.include('seganndb_login.utility')
...
class TestUtility(Base):
    ...
    def get_googleapi(self, path='/'):
        from seganndb_login.utility import ApiClient
        return ApiClient(self.get_request(path))


@mock.patch('seganndb_login.utility.requests.post')
...
@mock.patch('seganndb_login.utility.requests.get')
